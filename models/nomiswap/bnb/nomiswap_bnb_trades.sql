...
SELECT
    ...
    CAST(nomiswap_dex.token_bought_amount_raw AS DOUBLE) AS token_bought_amount_raw,
    CAST(nomiswap_dex.token_sold_amount_raw AS DOUBLE) AS token_sold_amount_raw,
    coalesce(
