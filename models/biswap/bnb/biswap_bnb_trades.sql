...
SELECT 'bnb'                                                           AS blockchain,
       ...
       CAST(biswap_dex.token_bought_amount_raw AS DOUBLE) AS token_bought_amount_raw,
       CAST(biswap_dex.token_sold_amount_raw AS DOUBLE) AS token_sold_amount_raw,
       coalesce(
...
LEFT JOIN {{ source('prices', 'usd') }} p_bought
    ...
    AND from_hex(p_bought.contract_address) = biswap_dex.token_bought_address
...
LEFT JOIN {{ source('prices', 'usd') }} p_sold
    ...
    AND from_hex(p_sold.contract_address) = biswap_dex.token_sold_address
