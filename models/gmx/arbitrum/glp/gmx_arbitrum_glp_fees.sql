...
WITH minute AS  -- This CTE generates a series of minute values
    ...
    FROM
        ...
        SELECT explode(sequence(TIMESTAMP TIMESTAMP '{{project_start_date}}', CURRENT_TIMESTAMP, INTERVAL 1 minute)) AS minute -- 2021-08-31 08:13 is the timestamp of the first vault transaction
        {% endif %}
        {% if is_incremental() %}
