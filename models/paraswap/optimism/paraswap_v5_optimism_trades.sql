...
{% set project_start_date = '2022-07-20' %}
{% set trade_event_tables = [
    source('paraswap_optimism', 'AugustusSwapper_evt_BoughtV3')
    ,source('paraswap_optimism', 'AugustusSwapper_evt_SwappedV3')
] %}
