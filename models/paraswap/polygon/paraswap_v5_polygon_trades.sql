...
{% set project_start_date = '2021-08-24' %}
{% set trade_event_tables = [
    source('paraswap_polygon', 'AugustusSwapperV5_evt_Bought')
    ,source('paraswap_polygon', 'AugustusSwapperV5_evt_Bought2')
    ,source('paraswap_polygon', 'AugustusSwapperV5_evt_BoughtV3')
