...
SELECT 'bnb'                                                             AS blockchain,
       ...
       CAST(babyswap_dex.token_bought_amount_raw  AS DOUBLE) AS token_bought_amount_raw,
       CAST(babyswap_dex.token_sold_amount_raw AS DOUBLE) AS token_sold_amount_raw,
       coalesce(
...
LEFT JOIN {{ source('prices', 'usd') }} p_bought
    ...
    AND from_hex(p_bought.contract_address) = babyswap_dex.token_bought_address
...
LEFT JOIN {{ source('prices', 'usd') }} p_sold
    ...
    AND from_hex(p_sold.contract_address) = babyswap_dex.token_sold_address
